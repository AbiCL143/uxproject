...
function Resumen_de_Rubrica() {
    const [openIndex, setOpenIndex] = useState(null); // Para manejar el acordeón
    const [isModalOpen, setIsModalOpen] = useState(false); // Para manejar la apertura y cierre del modal
    const [selectedCategory, setSelectedCategory] = useState(''); // Para manejar la categoría seleccionada
    ...
    useEffect(() => {
        // Cargamos las categorías desde los datos de ejemplo al estado
            ...
            <div className='w-3/4 h-3/4 mx-auto'>
                ...
                <div className="flex justify-end mt-4">
                    ...
                    >
                        ...
                        <Link to="/home" type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Terminar</Link>
                    </div>
                </div>
