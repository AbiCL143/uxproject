...
function Registrer() {
    return (
        <div className='bg-fondo h-screen overflow-hidden'>
          <NavBar />
          <div className='bg-fondo text-white p-4 mt-7'>
                ...
                <div className="w-full bg-cards rounded-lg shadow dark:border md:mt-0 sm:max-w-sm xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                  <div className="p-4 space-y-4 md:space-y-6 sm:p-6">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                      <div>
                        <label for="nombre" className="block mb-1 text-sm font-medium dark:text-white">Nombre</label>
                        <input type="text" name="nombre" id="nombre" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                      </div>
                      <div>
                        <label for="email" className="block mb-1 text-sm font-medium dark:text-white">Correo</label>
                      ...
                      <div>
                        <label for="usuario" className="block mb-1 text-sm font-medium dark:text-white">Usuario</label>
                      ...
                      <div>
                        <label for="password" className="block mb-1 text-sm font-medium dark:text-white">Contraseña</label>
