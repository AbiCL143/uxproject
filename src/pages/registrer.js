...
function Registrer() {
  ...
  return (
    <div className='bg-fondo min-h-screen overflow-auto'>
      <NavBar />
      <div className='bg-fondo text-white p-4 mt-16'> {/* Aumenta el margen superior para que no se solape con el NavBar */}
        <section className="bg-fondo min-h-full w-full">
