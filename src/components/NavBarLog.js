    ...
    return (
        <nav className="bg-fondo fixed w-full z-20 top-0 start-0">
            ...
            <div
                ...
                className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} bg-white dark:bg-gray-800`}
                tabIndex="-1"
